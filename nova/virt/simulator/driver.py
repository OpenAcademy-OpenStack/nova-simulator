...
"""
A fake (in-memory) hypervisor+api that simulates errors and capacity
changes. Largely based on fake.py.
...
CONF.import_opt('simulator_error_probability', 'nova.virt.simulator.driver')
CONF.import_opt('simulator_delay_probability', 'nova.virt.simulator.driver')
CONF.import_opt('simulator_delay_ms', 'nova.virt.simulator.driver')
